...
namespace ProjectHorizon.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220919124531_DeploymentSchedules")]
    partial class DeploymentSchedules
    {
            ...
            modelBuilder.Entity("ProjectHorizon.ApplicationCore.Entities.DeploymentSchedule", b =>
                {
                    b.HasOne("ProjectHorizon.ApplicationCore.Entities.DeploymentSchedulePhase", "CurrentPhase")
                        .WithOne()
                        .HasForeignKey("ProjectHorizon.ApplicationCore.Entities.DeploymentSchedule", "CurrentPhaseId")
