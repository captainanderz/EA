...
namespace ProjectHorizon.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220401075907_AddDescriptionPropertyToApps")]
    partial class AddDescriptionPropertyToApps
    {
            ...
            modelBuilder.Entity("ProjectHorizon.ApplicationCore.Entities.PublicShoppingRequest", b =>
                {
                    ...
                    b.HasIndex("ApplicationId", "SubscriptionId");
            ...
            modelBuilder.Entity("ProjectHorizon.ApplicationCore.Entities.PublicShoppingRequest", b =>
                {
                    b.HasOne("ProjectHorizon.ApplicationCore.Entities.SubscriptionPublicApplication", "SubscriptionPublicApplication")
                        .WithMany()
                        .HasForeignKey("ApplicationId", "SubscriptionId")
                        .HasPrincipalKey("PublicApplicationId", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
