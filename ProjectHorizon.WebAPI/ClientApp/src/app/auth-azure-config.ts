...
export const msalConfig: Configuration = {
  auth: {
    clientId: '123', // This is the ONLY mandatory field that you need to supply.
    authority: 'https://login.microsoftonline.com/organizations', // Defaults to "https://login.microsoftonline.com/common"
    redirectUri: '/sign-up-azure', // Points to window.location.origin. You must register this URI on Azure portal/App Registration.
